...
CREATE TABLE IF NOT EXISTS `campus_eats_fall2020`.`ratings` (
  ...
  `restaurant_review` VARCHAR(450) NULL DEFAULT NULL,
  `driver_review` VARCHAR(450) NULL DEFAULT NULL,
  `photo_uploaded` VARCHAR(450) NULL DEFAULT NULL,
...
Insert into ratings values(1,1,1,1,'Well Packed','Quick Delivery',null,'Nice');
Insert into ratings values(2,2,2,2,'Good Food','Fast Delivery',null,'Nice');
Insert into ratings values(3,3,3,3,'Tasty','Slow Delivery',null,'Nice');
Insert into ratings values(4,4,4,4,'Yummy','Quick Delivery',null,'Nice');
Insert into ratings values(5,5,5,5,'Bad Taste','Unprofessional Delivery',null,'Nice');
Insert into ratings values(6,6,6,6,'Nice Taste','Smooth Delivery',null,'Nice');
